...
function testDatabase(barcode) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, categoryId, styleId, sizeId, genderId, _b, category, style, size, gender, error_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    _b = _c.sent(), category = _b[0], style = _b[1], size = _b[2], gender = _b[3];
